...
from .functional_local import multi_head_attention_forward
...
class MultiheadAttention(Module):
    ...
    def forward(
        ...
        if self.batch_first and is_batched:
            # def T(w):
            #     return w.transpose(0, 1) if self.Wqkv.fan_in_fan_out else w
            #
            # lora_ABx = self.Wqkv.lora_dropout(query) @ T(self.Wqkv.merge_AB().T) * self.Wqkv.scaling
            # attn_output += lora_ABx
            return attn_output.transpose(1, 0), attn_output_weights
            # return attn_output.transpose(1, 0), attn_output_weights # Original
        else:
